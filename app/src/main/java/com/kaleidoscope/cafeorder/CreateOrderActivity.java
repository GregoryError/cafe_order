...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    public void onClickSendOrder(View view) {
        ...
        String order = String.format(getString(R.string.string_of_order), name, password, drink, optionOfDrink);
        String additions;
        if (builderAdditions.length() > 0) {
            additions = getString(R.string.string_additions) + builderAdditions.toString();
        } else additions = "";
